...
def get_mcp_instance() -> tuple[Any, Any, Any]:
    """Initialize and return the HDHomeRun MCP MCP instance, args, and middlewares.
    ...
    args, mcp, middlewares = create_mcp_server(
        ...
        version=__version__,
        instructions="HDHomeRun MCP MCP Server — condensed and verbose tool surfaces.",
    )

    register_tool_surface(
        mcp,
        service="hdhomerun-mcp",
...
def mcp_server():
    ...
    print(f"HDHomeRun MCP MCP v{__version__}", file=sys.stderr)
