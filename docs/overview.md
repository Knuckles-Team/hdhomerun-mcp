# hdhomerun-mcp — Concept Overview
...
HDHomeRun HTTP/DVR/Discovery API + hdhomerun_config protocol client + MCP Server + A2A Server
...
- **A2A Agent Server**: a Pydantic-AI graph agent (console script `hdhomerun-agent`)
